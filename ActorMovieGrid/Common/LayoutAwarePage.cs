...
namespace ActorMovieGrid.Common
{
    ...
    public class LayoutAwarePage : Page
    {
        ...
        /// <param name="navigationEvent">Event data describing the conditions that led to the event.</param>
        protected virtual void GoHome(object sender, RoutedEventArgs routedEvent)
        {
        ...
        /// </summary>
        /// <param name="sender">Instance that triggered the event.</param>
        /// <param name="navigationEvent">Event data describing the conditions that led to the
        /// event.</param>
        protected virtual void GoBack(object sender, RoutedEventArgs routedEvent)
        {
        ...
        /// <param name="navigationEvent">Event data describing the conditions that led to the
        /// event.</param>
        protected virtual void GoForward(object sender, RoutedEventArgs routedEvent)
        {
        ...
        /// <param name="navigationEvent">Event data that describes how the request was made.</param>
        ...
        public void StartLayoutUpdates(object sender, RoutedEventArgs routedEvent)
        {
        ...
        private void WindowSizeChanged(object sender, WindowSizeChangedEventArgs WindowSizeChangedEvent)
        {
        ...
        /// <param name="sender">Instance of <see cref="Control"/> that supports visual state
        /// management corresponding to view states.</param>
        /// <param name="routedEvent">Event data that describes how the request was made.</param>
        /// <remarks>The current view state will immediately be used to set the corresponding
        /// visual state when layout updates are requested.</remarks>
        /// <seealso cref="StartLayoutUpdates"/>
        public void StopLayoutUpdates(object sender, RoutedEventArgs routedEvent)
        {
            var control = sender as Control;
        ...
        //the parameter will cause other errors when changed, it should be "e", which in turn needs to be "more describing"
        protected override void OnNavigatedTo(NavigationEventArgs navigationEvent)
        {
            if (navigationEvent == null)
            {
                throw new ArgumentNullException("navigationEvent");
            }
            ...
            if (navigationEvent.NavigationMode == NavigationMode.New)
            {
                ...
                this.LoadState(navigationEvent.Parameter, null);
            }
            else
            {
                ...
                // from cache
                this.LoadState(navigationEvent.Parameter, (Dictionary<String, Object>)frameState[this._pageKey]);
            }
        }
